<template>
  <v-main>
    <v-subheader class="grey--text pa-0">Projects</v-subheader>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      //   { title: "Code up the homepage", person: "Chun Li", due: "10th Jan 2020", status: "complete", content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt consequuntur eos eligendi illum minima adipisci deleniti, dicta mollitia enim explicabo fugiat quidem ducimus praesentium voluptates porro molestias non sequi animi!"},
      //   { title: "Design video thumbnails", person: "Ryu", due: "20th Dec 2020", status: "complete", content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt consequuntur eos eligendi illum minima adipisci deleniti, dicta mollitia enim explicabo fugiat quidem ducimus praesentium voluptates porro molestias non sequi animi!"},
      //   { title: "Create a community forum.. again", person: "The Net Ninja", due: "20th Oct 2020", status: "overdue", content: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt consequuntur eos eligendi illum minima adipisci deleniti, dicta mollitia enim explicabo fugiat quidem ducimus praesentium voluptates porro molestias non sequi animi!"}
      // ]
    }),
    computed: {
      myProjects() {
